...
#                                                                             
# PROGRAMMER: Hanz Tantiangco
# DATE CREATED: May 9th 2020                                  
# REVISED DATE: May 10th 2020, 15:05 (1)
...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
            ...
            pet_label = ""
            name_processing = in_files[idx].lower().split("_")
